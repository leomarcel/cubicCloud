      ...
      if (ref.current.buffer === fboMain.texture && !transmissionSampler) {
        ...
        if (parent) {
          ...
          if (backside) {
            ...
            parent.material.roughness = backsideRoughness
            parent.material.anisotropicBlur = 1
            parent.material.color.set("#aaa")
          ...
          parent.material.roughness = roughness
          parent.material.anisotropicBlur = 0.1
          parent.material.color.set("white")
